...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_URL}/admin/system/health`;
    console.log(`Forwarding admin system health request to: ${backendUrl}`);
    ...
    console.error('Error in admin system health endpoint:', error);
    return NextResponse.json(
